...
# FADE IN TIME LAP
css_code += ".fade-anim { animation: fadeIn 2s ease-out forwards; }"
css_code += ".first-card-anim { animation: slideInLeft 2s ease-out forwards; }"
css_code += ".last-card-anim { animation: slideOutRight 2s ease-in forwards; }"
